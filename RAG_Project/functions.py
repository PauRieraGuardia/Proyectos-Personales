...
# En este pipeline estamos utilizando PROGRAMACIÓN HORIENTADA A OBJETOS (POO). 
# La Programación Orientada a Objetos es un paradigma de programación que organiza el software en torno a Clases, 
# las cuales actúan como moldes o planos para crear Objetos (instancias).
# - LA CLASE: class()
...
class QdrantStorage: 
    def __init__( # Esta función establece la conexión entre el codigo y la base de datos QDRANT, que esta corriendo dentro de un contenedor DOCKER. Es la infraestructura sobre la que va ha trabajar 
